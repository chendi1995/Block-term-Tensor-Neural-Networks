...
from tf_unet.layers import (weight_variable, bt_weight_variable,tt_weight_variable,weight_variable_devonc, bias_variable,
    ...
    for layer in range(0, layers):
        with tf.name_scope("down_conv_{}".format(str(layer))):
            ...
            if layer == 0:
                ...
                # w1 = bt_weight_variable([filter_size, filter_size, channels, features],Tuk_r=3,stddev=0.5)
                # print('bt layer...')
            ...
            if layer==(layers-1):
                ...
                # w2 = bt_weight_variable([filter_size, filter_size, features, features],Tuk_r=2,stddev=0.1)
                w2 = tt_weight_variable([filter_size, filter_size, features, features],TT_r=4,stddev=0.1)
